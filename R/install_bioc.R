...
BiocManager::install("ggord", suppressUpdates = suppressUpdate, update=update)
...
BiocManager::install("MOFA2", suppressUpdates = suppressUpdate, update=update)
...
BiocManager::install("miaSim", suppressUpdates = suppressUpdate, update=update)
