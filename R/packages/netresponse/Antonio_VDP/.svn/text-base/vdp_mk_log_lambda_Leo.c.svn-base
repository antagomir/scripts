...
void compute_variance(int ncentroids, int dim1, double *Ksi_alpha, 
...
void
allocate_memoryB(long datalen,int ncentroids,int dim1,int dim2,double ***S2_x,
...
void free_memoryB(int ncentroids,int dim1, int dim2, double ***Temp, 
		  double ***W,
